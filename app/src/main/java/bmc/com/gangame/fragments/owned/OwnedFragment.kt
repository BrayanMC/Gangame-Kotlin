package bmc.com.gangame.fragments.owned
...
class OwnedFragment : BaseListFragment() {
    ...
    private fun showError(error: Throwable) {
        ...
        if (view != null)
            Snackbar.make(view as View,
                    ...
                    .setAction(R.string.message_retry_request, { showMostOwnedGames() })
                    .show()
    }
